var Fs     = require("fs")
  ...
  , error500 = require('../utilities/error500')

module.exports = function(app) {

  console.log("WIKI ROUTE");
  ...
  app.get("/wiki/:page", pageShow);
  app.get("/wiki/:page/:version", pageShow);
  ...
  app.get("/pages/new", pageNew);
  app.get("/pages/new/:page", pageNew);
  ...
  app.get("/pages/:page/edit", function(req, res) {
  ...
  app.put("/pages/:page", function(req, res) {
  ...
  app.delete ("/pages/:page", function(req, res) {
  ...
  app.get("/wiki/:page/compare/:revisions", function(req, res) {
  ...
  app.get("/wiki/:page/history", function(req, res) {
  ...
  app.post("/misc/preview", function(req, res) {
    res.render('preview', {
      content: Renderer.render(req.body.data)
    });
  });

  app.get("/misc/syntax-reference", function(req, res) {
    res.render('syntax');
  });

  // Filters out pages that do not exist in the index
  app.get("/misc/existence", function(req, res) {
